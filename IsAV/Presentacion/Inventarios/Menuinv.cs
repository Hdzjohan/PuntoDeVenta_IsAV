...
using IsAV.Logica;
using IsAV.Datos;
using IsAV.Presentacion.REPORTES.REPORTES_DE_KARDEX_listo.Reporte_de_Kardex_diseño;
using IsAV.Presentacion.REPORTES.REPORTES_DE_KARDEX_listo.REPORTES_DE_INVENTARIOS_todos;
using IsAV.Presentacion.INVENTARIOS_KARDEX;
